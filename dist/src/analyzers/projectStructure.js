...
export async function analyzeProjectStructure(targetDir) {
    ...
    const candidates = [
        ...
        { label: 'Data directory exists', path: 'src/data', sev: 'medium', alt: ['e2e/src/data'] },
        {
            ...
            sev: 'medium',
            suggestion: 'Organizing environment-specific files in a dedicated directory improves clarity.',
            alt: [
        ...
        },
        {
            ...
            path: '.editorconfig',
            sev: 'high',
            suggestion: 'EditorConfig helps maintain consistent coding styles between different editors and IDEs.',
            alt: ['editorconfig'],
        },
        {
