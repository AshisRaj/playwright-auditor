...
// Severity levels used across analyzers and scoring
export type Severity = 'info' | 'low' | 'medium' | 'high' | 'critical';

// Each individual validation/check
...
// One analyzer/category section in the report
...
// The overall audit result emitted by the CLI and used by reporters
...
// (Optional) Scoring policy type if you expose/configure it
...
// (Optional) Generic result from an analyzer function signature
