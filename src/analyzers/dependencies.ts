...
export async function analyzeDependencies(targetDir: string): Promise<CategoryResult> {
  ...
  addFinding({
    ...
    message: (() => {
      ...
      if (presentKeys.length === 0) {
        return (
          'No lint-related script found (checked common variants: ' +
  ...
  addFinding({
    ...
    message: (() => {
      ...
      if (presentKeys.length === 0) {
        return (
          'No format-related script found (checked common variants: ' +
          formatNames.join(', ') +
          ').'
        );
      }
    ...
    suggestion: (() => {
      ...
      if (!anyPrettier) {
        return (
          'Ensure your format script runs Prettier (or an equivalent formatter). Example: ' +
  ...
  addFinding({
    ...
    message: (() => {
      ...
      if (presentKeys.length === 0) {
        return (
          'No clean-related script found (checked common variants: ' +
  ...
  addFinding({
    ...
    suggestion:
      usesCrossEnvInScripts && !hasCrossEnv
